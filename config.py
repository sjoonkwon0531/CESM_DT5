...
# 색상 팔레트 (Plotly 차트용)
COLOR_PALETTE = {
    "carbon": "#39ff14",  # 네온그린 (탄소)
    "scope1": "#ff6600",  # 네온오렌지 (Scope 1)
    "scope2": "#00f0ff",  # 시안 (Scope 2)
    "scope3": "#ff00ff",  # 마젠타 (Scope 3)
    "economics": "#ffd700", # 골드 네온 (경제)
    "pv": "#ffff00",      # 노란 네온 (태양광)
    "aidc": "#ff0040",    # 빨강 네온 (부하)
    "bess": "#00f0ff",    # 시안 (배터리)
    "grid": "#ff00ff",    # 마젠타 (계통)
    "h2": "#39ff14",      # 네온그린 (수소)
    "surplus": "#00ff80", # 밝은 녹색 네온 (잉여)
    "deficit": "#ff4080"  # 밝은 빨강 네온 (부족)
}
